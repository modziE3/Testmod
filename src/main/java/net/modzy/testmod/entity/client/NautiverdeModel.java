...
public class NautiverdeModel<T extends NautiverdeEntity> extends SinglePartEntityModel<T> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData Shell = nautiverde.addChild("Shell", ModelPartBuilder.create().uv(0, 24).cuboid(2.0F, -11.0F, -5.0F, 1.0F, 10.0F, 10.0F, new Dilation(0.0F))
		.uv(46, 31).cuboid(2.0F, -12.0F, -5.0F, 1.0F, 1.0F, 10.0F, new Dilation(0.0F))
		.uv(12, 50).cuboid(-4.0F, -12.0F, -5.0F, 1.0F, 1.0F, 10.0F, new Dilation(0.0F))
		.uv(42, 50).cuboid(-4.0F, -11.0F, -6.0F, 1.0F, 10.0F, 1.0F, new Dilation(0.0F))
		.uv(22, 0).cuboid(1.0F, -7.0F, -7.0F, 1.0F, 2.0F, 1.0F, new Dilation(0.0F))
		.uv(12, 24).cuboid(-3.0F, -7.0F, -7.0F, 1.0F, 2.0F, 1.0F, new Dilation(0.0F))
		.uv(0, 44).cuboid(2.0F, -1.0F, -5.0F, 1.0F, 1.0F, 10.0F, new Dilation(0.0F))
		.uv(36, 13).cuboid(-1.0F, -8.0F, -8.0F, 1.0F, 4.0F, 1.0F, new Dilation(0.0F))
		.uv(34, 50).cuboid(2.0F, -11.0F, 5.0F, 1.0F, 10.0F, 1.0F, new Dilation(0.0F))
		.uv(0, 24).cuboid(-2.0F, -9.0F, -7.0F, 3.0F, 6.0F, 1.0F, new Dilation(0.0F))
		.uv(12, 29).cuboid(-1.0F, -3.0F, -7.0F, 1.0F, 2.0F, 1.0F, new Dilation(0.0F))
		.uv(46, 53).cuboid(-4.0F, -11.0F, 5.0F, 1.0F, 10.0F, 1.0F, new Dilation(0.0F))
		.uv(46, 42).cuboid(-4.0F, -1.0F, -5.0F, 1.0F, 1.0F, 10.0F, new Dilation(0.0F))
		.uv(24, 34).cuboid(3.0F, -11.0F, -2.0F, 1.0F, 1.0F, 4.0F, new Dilation(0.0F))
		.uv(6, 31).cuboid(-1.0F, -11.0F, -7.0F, 1.0F, 2.0F, 1.0F, new Dilation(0.0F))
		.uv(24, 50).cuboid(-5.0F, -11.0F, -2.0F, 1.0F, 1.0F, 4.0F, new Dilation(0.0F))
		.uv(0, 0).cuboid(-3.0F, -12.0F, -6.0F, 5.0F, 12.0F, 12.0F, new Dilation(0.0F))
		.uv(24, 39).cuboid(3.0F, -10.0F, -4.0F, 1.0F, 1.0F, 4.0F, new Dilation(0.0F))
		.uv(0, 49).cuboid(-5.0F, -10.0F, 0.0F, 1.0F, 1.0F, 4.0F, new Dilation(0.0F))
		.uv(46, 31).cuboid(-5.0F, -2.0F, -2.0F, 1.0F, 1.0F, 4.0F, new Dilation(0.0F))
		.uv(32, 2).cuboid(3.0F, -3.0F, -4.0F, 1.0F, 1.0F, 4.0F, new Dilation(0.0F))
		.uv(0, 44).cuboid(-5.0F, -3.0F, 0.0F, 1.0F, 1.0F, 4.0F, new Dilation(0.0F))
		.uv(34, 34).cuboid(3.0F, -10.0F, 0.0F, 1.0F, 1.0F, 4.0F, new Dilation(0.0F))
		.uv(34, 39).cuboid(-5.0F, -3.0F, -4.0F, 1.0F, 1.0F, 4.0F, new Dilation(0.0F))
		.uv(12, 34).cuboid(3.0F, -9.0F, -5.0F, 1.0F, 6.0F, 10.0F, new Dilation(0.0F))
		.uv(12, 29).cuboid(3.0F, -3.0F, 0.0F, 1.0F, 1.0F, 4.0F, new Dilation(0.0F))
		.uv(12, 24).cuboid(3.0F, -2.0F, -2.0F, 1.0F, 1.0F, 4.0F, new Dilation(0.0F))
		.uv(38, 50).cuboid(2.0F, -11.0F, -6.0F, 1.0F, 10.0F, 1.0F, new Dilation(0.0F))
		.uv(34, 34).cuboid(-5.0F, -9.0F, -5.0F, 1.0F, 6.0F, 10.0F, new Dilation(0.0F))
		.uv(46, 36).cuboid(-5.0F, -10.0F, -4.0F, 1.0F, 1.0F, 4.0F, new Dilation(0.0F))
		.uv(46, 22).cuboid(-3.0F, -13.0F, -4.0F, 5.0F, 1.0F, 8.0F, new Dilation(0.0F))
		.uv(36, 13).cuboid(-3.0F, 0.0F, -4.0F, 5.0F, 1.0F, 8.0F, new Dilation(0.0F))
		.uv(24, 14).cuboid(-4.0F, -11.0F, -5.0F, 1.0F, 10.0F, 10.0F, new Dilation(0.0F)), ModelTransform.pivot(1.2629F, 6.4553F, 0.1039F));

		ModelPartData cube_r1 = Shell.addChild("cube_r1", ModelPartBuilder.create().uv(22, 6).cuboid(-2.0F, -0.3756F, 0.3301F, 3.0F, 4.0F, 2.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -11.0F, 9.0F, -1.8326F, 0.0F, 0.0F));

		ModelPartData cube_r2 = Shell.addChild("cube_r2", ModelPartBuilder.create().uv(22, 0).cuboid(-2.0F, -1.4871F, -0.5839F, 3.0F, 2.0F, 4.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -9.0F, 9.0F, -1.1781F, 0.0F, 0.0F));

		ModelPartData cube_r3 = Shell.addChild("cube_r3", ModelPartBuilder.create().uv(0, 0).cuboid(-2.0F, -5.0F, -4.0F, 3.0F, 5.0F, 3.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 0.0F, 6.0F, -1.0036F, 0.0F, 0.0F));

		ModelPartData cube_r4 = Shell.addChild("cube_r4", ModelPartBuilder.create().uv(34, 0).cuboid(-3.0F, -4.6699F, -9.7679F, 5.0F, 5.0F, 8.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -2.0F, 11.0F, -0.5672F, 0.0F, 0.0F));

		ModelPartData cube_r5 = Shell.addChild("cube_r5", ModelPartBuilder.create().uv(0, 9).cuboid(-3.0F, -1.5624F, -0.6105F, 3.0F, 2.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(1.0F, -9.0F, 9.0F, -0.5672F, 0.0F, 0.0F));
